...
const da = {
  ...
  "dueDiligence.noise.source": "Estimat (endnu ikke tilsluttet Miljøstyrelsens støjkort) — slå op",
  ...
  "dueDiligence.sewer.source": "Kommunens spildevandsplan (slås ikke automatisk op)",
...
const en: Translations = {
  ...
  "dueDiligence.noise.source": "Estimate (not yet wired to Miljøstyrelsen's noise map) — look up",
  ...
  "dueDiligence.sewer.source": "Municipality's spildevandsplan (not looked up automatically)",
