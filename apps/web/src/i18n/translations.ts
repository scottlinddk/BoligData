...
const da = {
  ...
  "filters.locationPlaceholder": "f.eks. Rundvejen 7, 9000 Aalborg",
  ...
  "detail.brokerListing": "Se hos mægler",
  "detail.brokerListingOn": "Se annoncen på {source}",
  "detail.price": "Pris",
  ...
  "detail.registerArea": "BBR-areal",
  "detail.registerAreaMismatch": "Salgsopstillingen angiver {listing} m²; BBR har registreret {register} m².",
  "register.title": "Registerkilder",
  "register.loading": "Henter registerdata...",
  "register.error": "Kunne ikke hente registerdata.",
  "register.badgeLive": "Register",
  "register.badgeStored": "Gemt",
  "register.mode.live": "live",
  "register.mode.mock": "mock",
  "register.mode.unavailable": "utilgængelig",
  "register.source.address": "Adresse (DAR)",
  "register.source.bbr": "Bygning (BBR)",
  "register.source.publicValuation": "Vurdering (VUR)",
  "register.source.noise": "Støjkort",
  "bbrFacts.matrikelnr": "Matrikelnr.",
  "bbrFacts.ejerlav": "Ejerlav",
  "bbrFacts.bfeNummer": "BFE-nummer",
  "zone.byzone": "Byzone",
  ...
  "comparables.nearbySales": "Salg i nærheden",
  "comparables.nearbyAvg": "Gennemsnit {price}/m² på tværs af {count} frie handler",
  "saleType.family": "familiehandel",
  "saleType.auction": "auktion",
  "saleType.other": "anden handel",
  "comparables.soldHistory": "Historik & sammenlignelige boliger",
  "comparables.noHistory": "Ingen registrerede handler for denne adresse.",
...
const en: Translations = {
  ...
  "filters.locationPlaceholder": "e.g. Rundvejen 7, 9000 Aalborg",
  ...
  "detail.brokerListing": "Go to broker listing",
  "detail.brokerListingOn": "View the listing on {source}",
  "detail.price": "Price",
  "detail.size": "Size",
  ...
  "detail.registerArea": "BBR area",
  "detail.registerAreaMismatch": "The listing states {listing} m²; BBR records {register} m².",
  "register.title": "Register sources",
  "register.loading": "Fetching register data...",
  "register.error": "Couldn't fetch register data.",
  "register.badgeLive": "Register",
  "register.badgeStored": "Stored",
  "register.mode.live": "live",
  "register.mode.mock": "mock",
  "register.mode.unavailable": "unavailable",
  "register.source.address": "Address (DAR)",
  "register.source.bbr": "Building (BBR)",
  "register.source.publicValuation": "Valuation (VUR)",
  "register.source.noise": "Noise map",
  "bbrFacts.matrikelnr": "Cadastral no.",
  "bbrFacts.ejerlav": "Cadastral district",
  "bbrFacts.bfeNummer": "BFE number",
  ...
  "comparables.nearbySales": "Sales nearby",
  "comparables.nearbyAvg": "Average {price}/m² across {count} arm's-length sales",
  "saleType.family": "family sale",
  "saleType.auction": "auction",
  "saleType.other": "other sale",
  "comparables.soldHistory": "History & comparables",
  "comparables.noHistory": "No registered sales for this address.",
